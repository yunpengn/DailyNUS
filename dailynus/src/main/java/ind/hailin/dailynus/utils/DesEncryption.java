...
public class DesEncryption {
	...
	public static String encryption(String encryStr) throws DesException {
		try {
			...
			return Base64.encodeBase64String(textEncryted);
	...
	private static SecretKey generateSecretKey() throws InvalidKeyException, NoSuchAlgorithmException,
